...
int main()
{
    ...
    float vertices[30] = {
        -0.8f, -0.8f, thickness, 0.0f, 0.0f, // left 0
         0.8f, -0.8f, thickness, 0.0f, 0.0f, // right 1
         0.0f,  0.8f, thickness, 0.0f, 0.0f, // top   2
		-0.8f, -0.8f,-thickness, 0.0f, 0.0f, // left  3 
         0.8f, -0.8f,-thickness, 0.0f, 0.0f, // right 4
         0.0f,  0.8f,-thickness, 0.0f, 0.0f  // top   5
    }; 
